# Generated by Django 4.0.6 on 2023-01-31 19:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PurchasePlan',
            fields=[
                ('planNo', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='销售单号')),
            ],
        ),
        migrations.CreateModel(
            name='ReceiptBill',
        ...
        migrations.CreateModel(
            name='PurchasePlanItems',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unit', models.CharField(max_length=100, verbose_name='采购单位')),
                ...
                ('createTime', models.CharField(max_length=50, verbose_name='订单创建时间')),
                ('purchasePlan', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.purchaseplan', verbose_name='po单')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.goodsspec', verbose_name='sku')),
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.supplier', verbose_name='供商')),
            ],
        ),
        ...
        migrations.AddConstraint(
            model_name='purchaseplanitems',
            constraint=models.UniqueConstraint(fields=('purchasePlan', 'sku'), name='采购计划单+商品不重复'),
        ),
        migrations.AddField(
            model_name='bom',
            name='unitGoods',
