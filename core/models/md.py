...
class GoodsSpec(models.Model):
	...
	skuId = models.CharField(verbose_name='商品SKU编码', max_length=100,unique=True)  # 商品SKU编码
...
class Store(models.Model):
	...
	storeType = models.SmallIntegerField(default='0')  # 0为对标门店
	storeNo = models.IntegerField(unique=True)  # 门店编码
...
class Supplier(models.Model):
	supplierNo = models.IntegerField(verbose_name='供商编码',unique=True)  # 供商编码
	...
	starValue = models.IntegerField(verbose_name='供商分值',null=True)  # 供商分值
